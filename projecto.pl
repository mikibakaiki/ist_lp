...
% puzzle_muda_propaga_aux(Puz, [H | T], Cont) :-
%
%     puzzle_ref(Puz, H, Cont_Aux),
%
%     member(Cont, Cont_Aux),
%
%     subtract(Cont_Aux, Cont, /* and what now ??*/),
%
%     puzzle_muda_propaga_aux(Puz, T, Cont).
%
